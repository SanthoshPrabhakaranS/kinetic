          ...
          <>
            <View style={styles.expandedHeader}>
              <View style={styles.expandedTitleRow}>
                ...
                <Text
                  style={[styles.expandedTitle, { color: colors.foreground }]}
                >
              ...
              <View style={styles.expandedHeaderActions}>
                ...
                >
                  <Feather
                    ...
                    size={16}
                    color={
                      soundEnabled ? colors.foreground : colors.mutedForeground
                    }
                  />
                </TouchableOpacity>
                <TouchableOpacity
            ...
            <View style={styles.timeWrap}>
              ...
              {!justFinished && (
                <Text
                  style={[styles.timeHint, { color: colors.mutedForeground }]}
                >
            ...
            <View style={styles.controlsRow}>
              ...
              >
                ...
                <Text
                  style={[styles.controlBtnText, { color: colors.foreground }]}
                >
                  30s
                </Text>
              </TouchableOpacity>
